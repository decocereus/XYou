...
function JsonViewer({ data }: Readonly<{ data: any }>) {
  return (
...
export default async function WhopInfo({
  params,
}: Readonly<{
  ...
  return (
    <div className="flex flex-col p-8 gap-4">
      ...
      <h3 className="text-6 font-bold">Ingest & Generate Threads</h3>
      <p className="text-3 text-gray-10">
        Paste a YouTube URL, send it to the ingestion backend, then generate
        twitter-ready threads from the transcript.
      </p>
    </div>
  );
}
